...
$Header: /sources/tsp/tsp/external/VxWorks/posix/posixThread.c,v 1.3 2005/04/12 07:40:15 le_tche Exp $
...
#include <vxWorks.h>
#ifndef _WRS_VXWORKS_5_X /* compile if VXWORKS is not 5.X */ /* FIXME : this will not work for VXWORKS 6.0 ! */
