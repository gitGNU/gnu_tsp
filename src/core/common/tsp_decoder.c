...
$Header: /sources/tsp/tsp/src/core/common/tsp_decoder.c,v 1.12 2008/06/24 19:32:02 rhdv Exp $
...
int32_t TSP_data_channel_double_decoder(void* out_double, uint32_t dimension,  char* in_buf)
{
  ...
  for(i=0;i<dimension;++i)
  {
    ...
    STRACE_DEBUG_MORE("decoded DOUBLE = %f, (received) encoded DOUBLE=0x%llx",((double*)out_double)[i],((uint64_t*)in_buf)[i]);
  }
#endif
